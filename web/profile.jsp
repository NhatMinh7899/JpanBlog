<%-- 
    Document   : profile
    Created on : Nov 15, 2020, 9:53:58 AM
    Author     : Admin
--%>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#"> <span class="	fa fa-bell-o"></span> Tiếng nhật cho bạn <span class="sr-only">(current)</span></a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-toggle="modal" data-target="#add-post-modal" > <span class="	fa fa-asterisk"></span> Tạo post</a>
                    </li>
                ...
                <ul class="navbar-nav mr-right">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="LogoutServlet"> <span class="fa fa-user-plus "></span> Thoát</a>
                    </li>
                </ul>
            </div>
        </nav>
                    ...
                    <div class="col-md-4">
                        <div class="list-group">
                            ...
                            <%  PostDao d = new PostDao(ConnectionProvider.getConnection());
                                ...
                                for (Category ds : list1) {
                            %>
                            <a href="#" onclick="getPosts(<%= ds.getCid()%>, this)" class=" c-link list-group-item list-group-item-action"><%= ds.getName()%></a>
                            <%                                        }
                    ...
                    <div class="modal-body">
                        <div class="container text-center">
                            ...
                            <div id="profile-edit" style="display: none;">
                                <h3 class="mt-2">Chỉnh sửa thông tin của bạn</h3>
                        ...
                        <form id="add-post-form" action="Add_Post_Controll" method="post">
                            ...
                            <div class="form-group">
                                <select class="form-control" name="cid">
                                    ...
                                    <!--Lấy danh sách hiện thị category-->
                                    <%
